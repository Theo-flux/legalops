    ...
    return (
      <section ref={ref} className={`relative ${className}`} {...props}>
        <div
          ...
          className="translate-y-24 bg-secondary/5 px-4 py-20 opacity-0 transition-all duration-500 ease-out data-[inview=true]:translate-y-0 data-[inview=true]:opacity-100"
        >
          {children}
        </div>
      </section>
