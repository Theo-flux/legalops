  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        ...
        "data-[state=open]:before:scale-x-100 data-active:bg-transparent data-active:text-primary",
